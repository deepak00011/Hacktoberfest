...
```py
'''
always make more then 6 pull request
lets you have made only 6 pull request to different projects
but one project is excluded from hackoctoberfest event then your pull request will not be count and 
then you have remains 5 valid pull request if these projects is not excluded.
if you fail to make 6 pull request then you cant get swags or t-shirts.
...
# Get quik merge request follow me 
deepakstark01
## Rules
